...
Requires:       ((python3dist(pywin32-ctypes) < 0.1.1 or python3dist(pywin32-ctypes) > 0.1.1) with (python3dist(pywin32-ctypes) < 0.1 or python3dist(pywin32-ctypes) > 0.1))
Requires:       python3dist(rst.linker) >= 1.9
Requires:       python3dist(secretstorage) >= 3
...
%changelog
* Mon Jun 15 2020 Tyler Griffiths <t@tyjgr.com> - 21.2.1-1
- Initial package.
